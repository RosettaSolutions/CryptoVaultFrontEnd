...
const Message = ({ messageType, message, description, onClose }: Props) => {
  return (
    <div
      className={`absolute top-24 left-1/2 transform -translate-x-1/2 z-50 w-fit h-fit px-3 py-2 bg-gray-50 rounded-md gap-2 shadow-md text-sm ${typeStyles[messageType]}`}
    >
